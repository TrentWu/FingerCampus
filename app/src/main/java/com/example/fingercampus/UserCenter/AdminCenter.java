...
public class AdminCenter extends Activity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.person_admin);
        intent =getIntent();
    ...
    public void UserRequest(final String usphone) {
        ...
        final StringRequest request = new StringRequest(Request.Method.POST, url,
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            if (result.equals("success")) {  //注⑤
                                ...
                                Toast.makeText(AdminCenter.this, "出错啦！", Toast.LENGTH_SHORT).show();
                            }
                        } catch (JSONException e) {
                            Toast.makeText(AdminCenter.this, "无网络连接", Toast.LENGTH_SHORT).show();
            ...
            public void onErrorResponse(VolleyError error) {
                Toast.makeText(AdminCenter.this, "请稍后重试", Toast.LENGTH_SHORT).show();
